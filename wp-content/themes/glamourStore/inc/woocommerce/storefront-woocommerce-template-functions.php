...
?>
        ...
        function storefront_product_categories($args)
        {
            $args = apply_filters(
                ...
                array(
                    ...
                    'child_categories' => 0,
                    'orderby'          => 'menu_order',
                    'title'            => __('Comprar por departamento', 'storefront'),
                )
            );
        ...
        function storefront_featured_products($args)
        {
            $args = apply_filters(
                ...
                array(
                    ...
                    'order'      => 'desc',
                    'visibility' => 'featured',
                    'title'      => __('Queridinhos', 'storefront'),
                )
            );
        ...
        function storefront_popular_products($args)
        {
            $args = apply_filters(
                ...
                array(
                    ...
                    'orderby' => 'rating',
                    'order'   => 'desc',
                    'title'   => __('Mais Procurados', 'storefront'),
                )
            );
        ...
        function storefront_best_selling_products($args)
        {
            $args = apply_filters(
                ...
                array(
                    ...
                    'orderby' => 'popularity',
                    'order'   => 'desc',
                    'title'   => esc_attr__('Mais vendidos', 'storefront'),
                )
            );
    ...
    ?>
        <nav class="storefront-product-pagination" aria-label="<?php esc_attr_e('Mais produtos', 'storefront'); ?>">
        ...
        function storefront_woocommerce_brands_homepage_section()
        {
            $args = apply_filters(
                ...
                array(
                    ...
                    'orderby'    => 'name',
                    'show_empty' => false,
                    'title'      => __('Comprar por marca', 'storefront'),
                )
            );
