...
<?php get_template_part('template-parts/content/arquivo-destinos-perfil'); ?>
<?php get_template_part('template-parts/content/arquivo-galeria'); ?>
<?php get_template_part('template-parts/content/arquivo-depoimentos'); ?>

<!-- < ?php get_template_part('template-parts/content/arquivo-destino-filtro-tipo-viagem'); ?>  -->
